...
url = 'http://fund.eastmoney.com/000834.html?spm=search'
...
# print(number)
## 读取文件
f = open("E:\python_project\limit2_data.txt","r")   #设置文件对象
...
if data!=number and number>=10000:
    ...
    with open('E:\python_project\limit2_data.txt','w') as f:    #设置文件对象
         f.write(number)                 #将字符串写入文件中
