...
url = 'http://fund.eastmoney.com/161130.html?spm=search'
...
# print(number)
## 读取文件
f = open("E:\python_project\limit_data.txt","r")   #设置文件对象
...
with open('E:\python_project\limit_data.txt','w') as f:    #设置文件对象
