...
@author 叶志豪2020
@date 2020/08/17
判断adobe买入卖出信号指标是否改变，是则发送邮件 （日周期）
"""
from bs4 import BeautifulSoup
import requests


url = 'https://m.cn.investing.com/equities/adobe-sys-inc-technical'
...
## 读取文件
f = open("E:\python_project\data.txt","r")   #设置文件对象
...
if data!=str:
    ...
    with open('E:\python_project\data.txt','w') as f:    #设置文件对象
